...
FIL fil; // file
FRESULT fresult; // storing result
...
//  Mount SD Card
	...
	if(fresult != FR_OK)
	{
	 snprintf(msg, sizeof(msg) - 1, "Mount unsuccessful!\r\n");
	 HAL_UART_Transmit(&huart2, (uint8_t*) msg, strlen(msg), HAL_MAX_DELAY);
	}
	else
	{
	 snprintf(msg, sizeof(msg) - 1, "Mount success!\r\n");
	 HAL_UART_Transmit(&huart2, (uint8_t*) msg, strlen(msg), HAL_MAX_DELAY);
	}
...
//  Writing text
	 fresult = f_puts("Hello there", &fil);
